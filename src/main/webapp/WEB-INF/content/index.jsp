		...
		<div class="panel panel-default" style="margin: 25px">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<div class="col-md-6">
						<label> From :</label> <select class="form-control-inline">
					...
					<div class="col-md-6">
						<label>To :</label> <select class="form-control-inline">
							<option>Colombo</option>
							<option>Galle</option>
							<option>Matara</option>
							<option>Kandy</option>
				...
				<div class="form-group">
					<div class="col-md-12">
						<label> Item :</label> <select class="form-control-inline">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<div class="form-group input-group">
							<span class="input-group-addon"><b>Kg</b></span> <input
								type="text" class="form-control" placeholder="Weight"><br>
						</div>
					</div>

					<div class="col-md-6">
						<label class="checkbox-inline"> <input type="checkbox"><b>Express</b>
						</label>
					</div>
				</div>
