...
function writeMessage() {
	...
	document.getElementById("container_1").innerHTML = document.getElementById("container").outerHTML;
	document.getElementById("container_2").innerHTML = document.getElementById("container").outerHTML;
}
</script>
<script>
function printData()
...
<p> <input type="text" size="20"  onkeyup="writeMessage()" id='text' value="Enter Parcel URL Here"> </p>
</form>
...
<table cellpadding="3" id="printTable">
	<tbody>
	<tr>
		<td rowspan="2" width="400"  height="600" style="border-right-style: dotted">
...
<div class="control left">
	<a id="banner" href="http://larsjung.de/qrcode/">jQuery.qrcode 0.10.1</a>
	<hr/>
	...
	<input id="size" type="range" value="200" min="100" max="1000" step="50" />
	...
	<input id="radius" type="range" value="0" min="0" max="50" step="10" />
</div>
