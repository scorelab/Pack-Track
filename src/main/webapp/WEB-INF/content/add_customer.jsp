             ...
             <tr>
                 ...
                 <td colspan='3'>
                  <table style="width:100%">
                    <s:textfield cssClass='input_class' type='text' name='nic' id='nic' value="%{nic}"/>
                    </table>
                  </td>
               </tr>
               <tr>
               ...
               <tr>
                 ...
                 <td colspan='3'>
                  <table style="width:100%">
                    <s:textfield cssClass='input_class' type='text' name='address' id='address'/>
                    </table>
                  </td>
               </tr>
               <tr>
                 ...
                 <td colspan='3'>
                  <table style="width:100%">
                    <s:textfield cssClass='input_class' type='text' name='mobile' id='mobile'/>
                    </table>
                  </td>
               </tr>
               <tr>
                 ...
                 <td colspan='3'>
                  <table style="width:100%">
                    <s:textfield cssClass='input_class' type='text' name='telephone' id='telephone'/>
                    </table>
                  </td>
               </tr>
                <tr>
