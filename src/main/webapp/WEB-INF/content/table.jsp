...
<ul class="nav nav-tabs" role="tablist" id="myTab">
  ...
  <li><a href="#SelectTrain" role="tab" data-toggle="tab">Select Train</a></li>
...
<table class="table table-striped" style="width:300px" align="center">
  ...
  <div class="tab-pane" id="SelectTrain">
    <table class="table table-hover table-striped table-bordered" style="width:300px" align="center">
